...
const HelpSupport = () => {
  return (
    <DashboardHeading heading="Help & Support">
      <div className="bg-white dark:bg-[#232323] px-3 py-5 mt-10 w-[80%] xl:w-[60%] lg:w-[90%] md:w-[100%] mobileView:w-[100%] rounded-2xl">
        <div className="flex tablet:flex-wrap mobileView:flex-nowrap xs:flex-wrap xxs:flex-wrap">
          <div className="w-full md:w-1/2 px-3 xss:px-0 mb-6 md:mb-3 tablet:w-full mobileView:w-1/2 xs:w-full">
            <label
              className="block text-black dark:text-[#ffffff63] text-xl mobileView:text-lg font-semibold mb-2 font-['Poppins'] "
              htmlFor="email"
            >
              Email
            </label>
            <div className="flex items-center bg-white dark:bg-[#171817] border-2 dark:border-none border-[#ccc] text-black dark:text-white p-3 h-12 rounded-xl">
              <Avatar path={LightImage.whiteMailIcon} className="mr-3 w-7" />
          ...
          <div className="w-full md:w-1/2 px-3 xss:px-0 mb-6 md:mb-3 tablet:w-full mobileView:w-1/2 xs:w-full">
            ...
            <div className="flex items-center bg-white dark:bg-[#171817] border-2 dark:border-none border-[#ccc] text-black dark:text-white p-3 h-12 rounded-xl">
              <Avatar path={LightImage.whiteMobile} className="mr-3 w-7" />
        ...
        <div className="p-3 xss:p-0 ">
          <h3 className="block text-black dark:text-[#ffffff63] text-xl mobileView:text-lg font-bold mb-2">
            Qus.1
          </h3>
          <div className="bg-white dark:bg-[#171817] border-2 dark:border-none border-[#ccc] p-3 rounded-xl">
            ...
            >
              ...
              <Avatar path={LightImage.whiteDownArrow} className="w-6" />
            </label>
