      ...
      <>
        ...
        >
          <input
            ...
            className={` w-12 h-12 smalldevice:w-10 smalldevice:h-10 text-center rounded-md font-['Poppins'] leading-tight py-2 px-2 focus:outline-none focus:shadow-outline bg-white dark:bg-[#343734] border-2 dark:border-none border-[#b9bcb56b] text-black dark:text-white xxs:text-[14px]`}
            type={this.getType()}
            maxLength="1"
            ref={this.input}
            disabled={isDisabled}
